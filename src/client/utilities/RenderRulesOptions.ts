...
const rulesOptions: { key: RuleKey; translationKey: string; hint?: string }[] =
  [
    { key: "disableNPCs", translationKey: "single_modal.disable_nations" },
    { key: "instantBuild", translationKey: "single_modal.instant_build" },
    { key: "infiniteGold", translationKey: "single_modal.infinite_gold" },
    { key: "infiniteTroops", translationKey: "single_modal.infinite_troops" },
    { key: "compactMap", translationKey: "single_modal.compact_map" },
  ];
